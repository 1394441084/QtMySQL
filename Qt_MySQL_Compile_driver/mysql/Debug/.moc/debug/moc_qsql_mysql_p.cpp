...
struct qt_meta_stringdata_QMYSQLDriver_t {
    QByteArrayData data[1];
    char stringdata0[13];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QMYSQLDriver_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QMYSQLDriver_t qt_meta_stringdata_QMYSQLDriver = {
    {
QT_MOC_LITERAL(0, 0, 12) // "QMYSQLDriver"
...
QT_INIT_METAOBJECT const QMetaObject QMYSQLDriver::staticMetaObject = { {
    QMetaObject::SuperData::link<QSqlDriver::staticMetaObject>(),
    qt_meta_stringdata_QMYSQLDriver.data,
    qt_meta_data_QMYSQLDriver,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *QMYSQLDriver::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QMYSQLDriver.stringdata0))
